        ...
        <table class="table table-bordered table-sm font-weight-100 font-size-12">
            ...
            <tr>
                ...
                <?php for ($i = 6; $i < 22; $i++):
                    ...
                    $x = $i + $z;
                    # Abrufe FAB ANlage
                    $abrufe[$i] = ProduktionDatabase::getAbrufeFabStunde('' . $_SESSION['wrk']['datum'] . '', '' . $_SESSION['parameter']['anfangszeit'][$x] . '', '' . $_SESSION['parameter']['endzeit'][$x] . '');
                    ?>
            ...
            <tr>
                <td class="text-end"><?= $_SESSION['text']['h_fahrzeuge'] ?> <?= $_SESSION['text']['h_fab'] ?></td>
                <?php for ($i = 6; $i < 22; $i++):
                    ?>
                    <td class="text-center">
                        <?= $abrufe[$i]*3 ?>
            ...
            <tr>
                ...
                <?php for ($i = 6; $i < 22; $i++):
                    ...
                    $takt[$i] = ($abrufe > 0) ? ProduktionDatabase::getTaktzeit($x, $abrufe) : 0;
                    ?>
                    <td class="text-center">
