    ...
    <div class="container-fluid">
        <div class="px-4 py-5"><!-- Inhalt -->
            <div class="row">
                ...
                <div class="col-12 col-md-4 border__right--dotted-gray">
                    <div class="mx-3">
                        <h3 class="border__bottom--dotted-gray mb-3 pb-3 font-weight-300"><?= $_SESSION['text']['h_apqp'] ?> <?= $_SESSION['text']['h_evaluation'] ?>
                            (<?= $evaluation ?>)</h3>
                        <?php
                        ...
                        # APQP
                        foreach (ChangeManagementDatabase::getAllApqpBereich($id, 1, $evaluation) as $apqp):
                ...
                <?php
                # Anzahl Kommentare
                $k = ChangeManagementDatabase::countComments(1, $id, $evaluation);
                if ($k == 0 && $edit !== 1):
                    ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        <?php
        foreach (ChangeManagementDatabase::getAllApqpBereich($id, 1, $evaluation) as $apqp): ?>
        getAPQPElement(<?= $id ?>, 1, <?= $apqp->apqp ?>, '<?= $row->location ?>');
        <?php
        endforeach;
        ?>
