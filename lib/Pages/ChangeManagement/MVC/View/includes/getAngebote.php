...
if ($edit == 1 || $seitelesen == 1):
    if (count($dateien) > 0):
        foreach ($dateien as $fl):
            ?>
            <div class="border__solid--gray_25 border__radius--5 p-2 linear__top--gray mb-2" id="fl<?= $fl->id ?>">
                    ...
                    <div class="col-11">
                        <div class="px-2">
                            ...
                            <p class="font-size-11 p-0 m-0">
                                ...
                                <?php if ($edit === 1 && $row->status < 6): ?>
                                    <span class="float-end">
                                    <i class="fa fa-trash text-danger ps-3 pointer"
                                       onclick="deleteFile(<?= $fl->id ?>);"></i>
                                </span>
                                <?php endif; ?>
                            </p>
                        </div>
